...
let
  sources = {
    ...
    "frida-objc-bridge-7.0.2" = {
      ...
      version = "7.0.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/frida-objc-bridge/-/frida-objc-bridge-7.0.2.tgz";
        sha512 = "IyKShbGf3bNxKxIavevCDBctg1Q+QAaFSMn9o1qOdY3ubRoeF3OGjs8Kjg47Dn1wu3fI/TywBfuWn2bHYRhYWA==";
      };
    };
    "frida-process-3.0.1" = {
      name = "frida-process";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."frida-objc-bridge-7.0.2"
