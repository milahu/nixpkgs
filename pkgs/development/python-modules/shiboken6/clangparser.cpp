                                               ...
                                               unsigned flags = 0)
{
    ...
    /*
        ...
        clang_parseTranslationUnit2(
            0x0,
            cmd[5]=
                -isystem/nix/store/vdfr889lwm84xzgabqhdnm9vwc0xrwy1-libcxx-9.0.1-dev/include/c++/v1
                -fPIC
                -Wno-constant-logical-operand
                -std=c++17
                /build/nothing_kYnQfK.hpp
        )
    */

    CXTranslationUnit tu;
#ifdef MILAHU_PATCH_ARGV0
    CXErrorCode err = clang_parseTranslationUnit2FullArgv(index, nullptr, argv.data(),
#else
