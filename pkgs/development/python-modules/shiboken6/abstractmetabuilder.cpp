...
{
    // milahu debug
    for (QByteArray arg : arguments) {
        std::cerr << "AbstractMetaBuilder::build arg = " << arg.constData() << '\n';
    }
    std::cerr << "AbstractMetaBuilder::build addCompilerSupportArguments = " << addCompilerSupportArguments << '\n';
