...
in {
  ...
  */
  ...
  pyqt6-webengine = pkgs.qt6Packages.callPackage ../development/python-modules/pyqtwebengine/6.x.nix {
    pythonPackages = self;
  };
  ...
  sip-pyqt6 = callPackage ../development/python-modules/sip/sip-pyqt6.nix { };
